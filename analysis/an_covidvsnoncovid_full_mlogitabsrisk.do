...
local marginsat "male=0 obese4cat=1 smoke_nomiss=1 ethnicity=1 imd=1 htdiag_or_highbp=0 			chronic_respiratory_disease=0 asthmacat=1 chronic_cardiac_disease=0 diabcat=1 cancer_exhaem_cat=1 			cancer_haem_cat=1 chronic_liver_disease=0 stroke_dementia=0	other_neuro=0 reduced_kidney_function_cat=1	organ_transplant=0 spleen=0	ra_sle_psoriasis=0 other_immunosuppression=0"
if "`1'"!="" {
...
frame create absolutes agegroup str30 variable level pcovdeath lcicov ucicov pnoncovdeath lcinoncov ucinoncov
...
getmargin		
frame post absolutes (`agegroup') ("") (99) (el(r(table), 1, 2)) (el(r(table), 5, 2)) (el(r(table), 6, 2)) (el(r(table), 1, 3)) (el(r(table), 5, 3)) (el(r(table), 6, 3)) 
...
forvalues i = `mintoget'/`maxtoget'{
	...
	if _rc==0 frame post absolutes (`agegroup') ("`vartoprocess'") (`i') (el(r(table), 1, 2)) (el(r(table), 5, 2)) (el(r(table), 6, 2)) (el(r(table), 1, 3)) (el(r(table), 5, 3)) (el(r(table), 6, 3))
} /*variable levels*/
} /*variables*/
} /*agegroups*/
